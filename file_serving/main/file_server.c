...
#define MAX_FILE_SIZE   (1000*1024) // 1 MB (200 KB)
...
static esp_err_t http_resp_dir_html(httpd_req_t *req, const char *dirpath)
{
    ...
    ".button.button-delete,button.button-delete,input[type=\"submit\"].button-delete,input[type=\"reset\"].button-delete,input[type=\"button\"].button-delete {color: #FFF;background-color: #f2121;border-color: #33C3F0; }"
    ...
    ".button.button-delete:hover,button.button-delete:hover,input[type=\"submit\"].button-delete:hover,input[type=\"reset\"].button-delete:hover,input[type=\"button\"].button-delete:hover,.button.button-delete:focus,button.button-delete:focus,input[type=\"submit\"].button-delete:focus,input[type=\"reset\"].button-delete:focus,input[type=\"button\"].button-delete:focus {color: #FFF;background-color: #e01010;border-color: #1EAEDB; }"
